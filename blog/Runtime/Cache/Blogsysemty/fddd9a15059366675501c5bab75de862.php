...
//    console.log(<?php echo ($client_arr); ?>);
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "local",
            height: 395,
            colNames:[' ', 'ID','name','url', 'time', 'sort'],
            colModel:[
                ...
                {name:'url',index:'ship', width:90, editable: true,edittype:"text"},
                {name:'newtime',index:'sdate',width:90, editable:false, sorttype:"date",unformat: pickDate},
                {name:'sort',index:'ship', width:90, editable: true,edittype:"text"},
            ...
            editurl: "<?php echo U('Friendlink/editfriendlink');?>",//nothing is saved
