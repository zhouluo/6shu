														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="/Public/blogadmin/avatars/user.jpg" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="/Public/blogadmin/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="/Public/blogadmin/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="/Public/blogadmin/avatars/avatar5.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="/Public/blogadmin/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar" src="/Public/blogadmin/avatars/avatar3.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar" src="/Public/blogadmin/avatars/avatar4.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="/Public/blogadmin/avatars/avatar1.png" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe's Avatar" src="/Public/blogadmin/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="/Public/blogadmin/avatars/avatar1.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe's Avatar" src="/Public/blogadmin/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita's Avatar" src="/Public/blogadmin/avatars/avatar3.png" />
																	</div>
												...
												<div class="widget-main no-padding">
													<div class="dialogs">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa's Avatar" src="/Public/blogadmin/avatars/avatar1.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="/Public/blogadmin/avatars/avatar.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="/Public/blogadmin/avatars/user.jpg" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="/Public/blogadmin/avatars/avatar4.png" />
															</div>
...
<script src="/newblog/Public/blogadmin/js/jquery.min.js"></script>
...
<script type="text/javascript">
    window.jQuery || document.write("<script src='/newblog/Public/blogadmin/js/jquery-2.0.3.min.js'>"+"<"+"script>");
</script>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='/newblog/Public/blogadmin/js/jquery-1.10.2.min.js'>"+"<"+"script>");
</script>
<![endif]-->

<script type="text/javascript">
    if("ontouchend" in document) document.write("<script src='/newblog/Public/blogadmin/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
</script>
<script src="/newblog/Public/blogadmin/js/bootstrap.min.js"></script>
<script src="/newblog/Public/blogadmin/js/typeahead-bs2.min.js"></script>

<!-- page specific plugin scripts -->

<!--[if lte IE 8]>
<script src="/newblog/Public/blogadmin/js/excanvas.min.js"></script>
<![endif]-->

<script src="/newblog/Public/blogadmin/js/jquery-ui-1.10.3.custom.min.js"></script>
<script src="/newblog/Public/blogadmin/js/jquery.ui.touch-punch.min.js"></script>
<script src="/newblog/Public/blogadmin/js/jquery.slimscroll.min.js"></script>
<script src="/newblog/Public/blogadmin/js/jquery.easy-pie-chart.min.js"></script>
<script src="/newblog/Public/blogadmin/js/jquery.sparkline.min.js"></script>
<script src="/newblog/Public/blogadmin/js/flot/jquery.flot.min.js"></script>
<script src="/newblog/Public/blogadmin/js/flot/jquery.flot.pie.min.js"></script>
<script src="/newblog/Public/blogadmin/js/flot/jquery.flot.resize.min.js"></script>

<!-- ace scripts -->

<script src="/newblog/Public/blogadmin/js/ace-elements.min.js"></script>
<script src="/newblog/Public/blogadmin/js/ace.min.js"></script>
